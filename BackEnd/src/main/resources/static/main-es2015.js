    ...
    onFileChanged(event) {
        ...
        fr.onload = () => {
            this.img.onload = () => {
                ...
                if (this.img.width == 400 && this.img.height == 400)
